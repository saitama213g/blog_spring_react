...
const IfAlreadyLogedIn = ({ children }: { children: React.ReactNode }) => {
  const { isAuthenticated } = useAuth();
  ...
  return (
    <BrowserRouter>
      <NavBar 
        ...
        onLogout={logout}
      />
      <main className="container mx-auto py-6 min-h-screen bg-gradient-to-b from-teal-50/30 to-cyan-50/30">
        <Routes>
