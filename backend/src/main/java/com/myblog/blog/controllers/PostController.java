...
import com.myblog.blog.mappers.PostMapper;
...
public class PostController {
    ...
    // public ResponseEntity<String> getId(@RequestAttribute UUID userId)
    // {
    //     return ResponseEntity.ok("you token is :" + userId);
    // }
    ...
    public ResponseEntity<PostDto> updatePost(
        ...
        Post updatedPost = postService.updatePost(updatePostRequest.getId(), updatePostRequest);
